...
#define VER_SIZE         20
#define WDT_SET_IND_TIME 500 //500mS second
...
eStatus CTRLL_SendEvent(sCtrlLayer *ctrll, u16 eventId , u8* dataptr, u8 datalen) __REENTRANT__;
 ...
 *
 * $Log: ctrll.h,v $
 * Revision 1.8  2014/10/28 16:27:43  kiran
