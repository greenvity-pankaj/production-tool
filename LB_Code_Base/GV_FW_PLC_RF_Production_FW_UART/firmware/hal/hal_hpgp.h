/*
* $Id: hal_hpgp.h,v 1.37 2015/01/02 14:55:35 kiran Exp $
*
...
#define MAX_50HZ_BPLEN               0xF6000
#define MIN_50HZ_BPLEN               0xF3000
...
#define UPPER_MAC       1
#define LOWER_MAC       2
#define PLC_SM_MAX_CLK_CNT			0x8000000		// Max clock cycles before rendered hang (1 clock cycle~=40ns) This value equates to 5Sec
...
#endif
#ifdef LLP_POWERSAVE
	u8 psSta;			// apply to this STA: 0: disabled, 1: enabled
	psModeData savedPsMode;	// saved PS mode info. Used in the case of rescan
#endif
	u32 zcInt;
