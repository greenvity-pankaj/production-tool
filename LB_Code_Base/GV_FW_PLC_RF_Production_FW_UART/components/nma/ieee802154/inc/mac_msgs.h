 ...
 * @file: return_val.h
 * 
 * @brief: Message structures for the IEEE 802.15.4 MAC. 
 * 
...
typedef struct mcps_data_req1_s
{
    uint8_t cmdcode;
    /**
     * The source addressing mode for this primitive and subsequent MPDU. This
...
typedef struct mcps_data_ind1_s
{
    uint8_t cmdcode;
    /**
     * The source addressing mode for this primitive corresponding to the
