...
eStatus MUXL_TransmitMgmtMsg(sEvent *event)
{
    sMmHdr    *mmh = NULL;
...
//        mux->fnmi = mmh->fnmi; //??
        ...
        if(mux->rxqlen == (mux->rxnfmi+1))
        {
           ...
           FM_Printf(FM_ERROR, "MUX:Msg reassembly not supported\n");
        }
    }
 ...
 *
 * Revision 1.7  2014/10/28 16:27:43  kiran
