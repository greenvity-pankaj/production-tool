...
#define NETDISC_OPT_CCO_DET     				BIT(0)
#define NETDISC_OPT_CCO_SEL     				BIT(1)
...
#define HPGP_TX_RETRY_MAX       				3
#define HPGP_NETWORK_EXIT_REASON_USER_REQ  		0
#define HPGP_NETWORK_EXIT_REASON_PWR_DOWN  		1
#define HPGP_LEAVE_REQ_REASON_USER_REQ        	0 
#define HPGP_LEAVE_REQ_REASON_PWR_DOWN        	1  
#define HPGP_LEAVE_IND_REASON_USER_REQ        	0
#define HPGP_LEAVE_IND_REASON_TEI_EXP         	1
#define HPGP_LEAVE_IND_REASON_CCO_DOWN        	2
#define HPGP_LEAVE_IND_REASON_RSVD			  	3
#define HPGP_HO_REASON_CCO_APPT    				0x0
#define HPGP_HO_REASON_CCO_SLCT    				0x1
#define HPGP_HO_REASON_CCO_LEAVE   				0x2
...
#define MMTYPE_CC_BACKUP_APPOINT_CNF     		0x0005
...
#ifdef KEEP_ALIVE
#define MMTYPE_VENDOR_KEEP_ALIVE_IND			(0xA000 + 0x00)
#endif
//hybrid mode
...
//beacon type
#define BEACON_TYPE_CENTRAL            			0x0
#define BEACON_TYPE_DISCOVER           			0x1
#define BEACON_TYPE_PROXY              			0x2
//network mode
#define NET_MODE_UNCCORDINATED         			0x0
#define NET_MODE_CCORDINATED           			0x1
#define NET_MODE_CSMA_ONLY             			0x2
//CCo capability
#define CCO_CAP_LEVEL0                 			0x0
#define CCO_CAP_LEVEL1                 			0x1
#define CCO_CAP_LEVEL2                 			0x2
#define CCO_CAP_LEVEL3                 			0x3
//Beacon Entry Header 
#define BEHDR_NON_PERSISTENT_SCHED     			0x00
#define BEHDR_PERSISTENT_SCHED         			0x01
#define BEHDR_REGIONS                  			0x02
