...
#define    CRM_SCB_MAX               30 //10 //70 // 12  //128
#define    CRM_SCB_BUCKET_MAX        (CRM_SCB_MAX/CRM_SCB_HASH_TABLE_SIZE)

#define    DISC_STA_LIST_MAX   3 //100 // 4
#define    DISC_NET_LIST_MAX   6// 3 Kiran
...
//[pm]    u8          nmkIv[ENC_IV_LEN]; /* IV for NMK */
...
//[pm]    u8          ppekEks;            /* EKS for NEK */
//[pm]    u8          ppek[ENC_KEY_LEN];  /* NEK */
 ...
 *
 * $Log: crm.h,v $
 * Revision 1.17  2015/01/02 14:55:36  kiran
 ...
 *
 * Revision 1.16  2014/12/09 07:09:08  ranjan
 * - multicco feature under MCCO flag
 *
 * Revision 1.15  2014/12/04 09:51:16  prashant
 * Rssi and Lqi added in beacon processing
 *
 * Revision 1.14  2014/09/30 21:47:18  tri
 * Added LLP PS
 *
