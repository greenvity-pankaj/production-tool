...
#define MAX_NO_BEACON_NW_DISCOVERY    18   // Before STA starts N/w Discovery
#define MAX_NO_BEACON_PASSIVE_CCO     18   // Before STA starts N/w Discovery


#define AC_TO_DC_TIME       200 // 200ms
...
*/
	...
	tTimerId	discStallTimer;
	tTimerId	bcnStallTimer;
	tTimerId    scanToAssocTimer;
}sSnsm, *psSnsm;
#ifdef BCN_ERR
extern u8 bpstoFound;
#endif
 ...
 *
 * $Log: nsm.h,v $
 * Revision 1.13  2015/01/02 14:55:36  kiran
 ...
 *
 * Revision 1.12  2014/12/09 07:09:08  ranjan
 * - multicco feature under MCCO flag
 *
 * Revision 1.11  2014/11/11 14:52:58  ranjan
 ...
 *
 * Revision 1.10  2014/10/28 16:27:43  kiran
