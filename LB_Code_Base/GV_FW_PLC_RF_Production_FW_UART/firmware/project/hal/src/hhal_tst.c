/*
*
* $Id: hhal_tst.c,v 1.18 2014/11/11 14:52:58 ranjan Exp $
*
...
//	}	
	...
	else if(strcmp(cmd, "uartstat") == 0)
	{
		...
		FM_Printf(FM_USER, "UART Rx Flag %bu\n",uartRxControl.uartRxFlag);
		#ifndef UART_RAW
		...
		FM_Printf(FM_USER,"Uart RX Tick %lu\n",uartRxControl.tick);
		FM_Printf(FM_USER,"Uart Rx Timeout %lu\n",uartRxControl.timeout);
		FM_Printf(FM_USER,"Stm Tick %lu\n",Stm.timeTick);
		//intStatus = EA;
		//printf("Global EA = %bx\n",intStatus);
