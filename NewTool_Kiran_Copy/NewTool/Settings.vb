...
#Region "Structure Declerations"
    ...
    Public Structure sFlashHeader
        <FieldOffset(0)> <MarshalAs(UnmanagedType.U2)> Public sectorAddress As UShort
    End Structure

    <StructLayout(LayoutKind.Sequential, Pack:=1, Size:=24)>
    Public Structure sFlashMacSerial
        <FieldOffset(0)> <MarshalAs(UnmanagedType.ByValArray, SizeConst:=(MAC_ADD_LEN - 2))> Public macAddress As Byte()
        <FieldOffset(6)> <MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst:=18)> Public serialNo As Byte()
    End Structure
#End Region
