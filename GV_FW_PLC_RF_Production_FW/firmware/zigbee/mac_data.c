 ...
 *
 * $Id: mac_data.c,v 1.6 2014/11/26 13:19:41 ranjan Exp $
 *
...
#if (defined UM) && (!defined ZBMAC_DIAG)
			mlme_send_to_host(buffer_header);
#else
...
void mac_data_process_packet (buffer_t *buf_ptr)
{
    ...
    mac_parse_data.ppdu_rssi = 
                       frame_ptr->mpdu_p[mac_parse_data.mpdu_length + LQI_LEN + 1];
