...
Public Class Form1
    ...
    Dim stringBootloader_hirel As String = "**       HI - REL Boot loader V4.0         **"
    ...
    Dim bank_file(8) As String ' This has splitted and optimized hex files if file with .hex extension is selected  
...
#ElseIf FEATURE = "DEVELOPER" Then
    Const PRODUCT_TITLE As String = "Flashing Utility HI-REL Boot "
        ...
        If portopen = False Then
            ...
            Try
                With SerialPort1
                    ...
                    .BaudRate = combobx_baudRate.Text
        ...
        If e.EventType = SerialData.Chars Then
		    ...
		    backspaceCheck = false
                    ...
                    If cmdEraseFlash = 1 Then
                        ...
                        If (serialString.IndexOf(stringGreenvity, position) >= 0) And ((serialString.IndexOf(stringBootloader, position) >= 0) Or (serialString.IndexOf(stringBootloader_hirel, position) >= 0)) Then
                            ...
                            Try
                                With SerialPort1
                                    If (chkbx_boot_backup.Checked) Then
                                        .Write("f")
                                    Else
                                        .Write("F")
                                    End If
                ...
                Else
                    ...
                    Try
                        ...
                        Else
                            ...
                            lbl_filename.Text = txtbx_fileName.Text & ": Bank: " & j.ToString
                        End If
