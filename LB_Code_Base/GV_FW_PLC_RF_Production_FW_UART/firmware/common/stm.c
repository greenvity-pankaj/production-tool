...
void STM_ProcTimer(u8 mid, u16 type, void *cookie)
{
    switch(mid)
    {
		...
		case HP_LAYER_TYPE_APP:
		{
			...
			timerevent.app_id = (u8)(*((u8*)cookie));
			timerevent.type = type;
			Host_SendIndication(HOST_EVENT_APP_TIMER, SYS_MAC_ID,
 ...
 *
 * $Log: stm.c,v $
 * Revision 1.19  2014/11/26 13:19:39  ranjan
 * *** empty log message ***
 *
 * Revision 1.18  2014/11/11 14:52:56  ranjan
