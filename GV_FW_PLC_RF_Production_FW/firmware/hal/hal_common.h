/*
* $Id: hal_common.h,v 1.25 2015/01/03 12:56:14 kiran Exp $
*
...
typedef enum _eHybriiPortNum                 // used internally by HAL
{
    ...
    PORT_SPI    = 4,    
    PORT_HOST   = 5,
    PORT_APP    = 6, // this is not defined by HW. any new HW enum should be defined before PORT_HOST
    PORT_PERIPHERAL = 7 
...
#define RESET_REASON_WDTRST		0x02
#define RESET_REASON_SWSYSRST	0x04
#define RESET_REASON_SWCPURST	0x08

#define RESET_CTRL_REG			0x34
#define RESET_STAT_REG			0x38

#define TIMER_STAT_REG			0x100
#define TIMER0_LOAD_REG			0x110
#define TIMER0_VALUE_REG		0x114
#define TIMER0_CTRL_REG			0x118
#define TIMER1_LOAD_REG			0x120
#define TIMER1_VALUE_REG		0x124
#define TIMER1_CTRL_REG			0x128

#define RESET_SYS 				0x01
#define RESET_CPU 				0x10

//#define SYSTEM_CLOCK 			25000000

typedef enum
{
	SYSTEM_CLOCK_PRESCALE = 0,
	SYSTEM_CLOCK_4_PRESCALE,
	SYSTEM_CLOCK_8_PRESCALE,
	SYSTEM_CLOCK_16_PRESCALE,
	SYSTEM_CLOCK_32_PRESCALE,
	SYSTEM_CLOCK_64_PRESCALE,
	SYSTEM_CLOCK_128_PRESCALE,
	SYSTEM_CLOCK_256_PRESCALE,
	SYSTEM_CLOCK_512_PRESCALE,
	SYSTEM_CLOCK_1024_PRESCALE,
	SYSTEM_CLOCK_2048_PRESCALE,
	SYSTEM_CLOCK_4096_PRESCALE,
	SYSTEM_CLOCK_8192_PRESCALE,
	SYSTEM_CLOCK_16384_PRESCALE,
	SYSTEM_CLOCK_32768_PRESCALE,
	SYSTEM_CLOCK_65535_PRESCALE = 15 // Approx 3 minutes
}timerPrescale;
...
void GV701x_Chip_Reset();
#ifdef SW_RECOVERY

#define CSMA_RETRY_COUNT 20
#define OTHERS_RETRY_COUNT 20
#endif
#ifdef LOG_FLASH
